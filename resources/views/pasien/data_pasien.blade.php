...
<script>
    ...
    $('#modal-hapus-pasien').on('show.bs.modal', function (event) {
        ...
        var modal = $(this)
        modal.find('.modal-body #modal_body_delete').text('Apakah anda yakin ingin menghapus pasien atas nama ' + nama + '? Apabila pasien dihapus, maka semua data yang berkaitan dengan pasien ini tidak akan menampilkan detail dari data pasien ini.')
        $('#id_pasien').val(id)
    });
